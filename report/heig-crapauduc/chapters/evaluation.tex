...
Les widgets tensorboard permettent durant tous les entrainments d'avoir un apercu des différentes métriques enregistrées nous pouvons donc arreter l'entrainement au meilleur moment afin de ne pas overfit. Nous avons pris quelques captures d'écrans affichées dans les figures \ref{fig:tensorboard_overview} et \ref{fig:tensorboard_metric}
\begin{figure}[h!]
    \centering
    \scalebox{0.5}[0.5]{\includegraphics[width=\textwidth]{images/tensorboard_large.png}}
    ...
    \caption{Aperçu des metrics enregistrées dans TensorBoard}
    \label{fig:tensorboard_metric}
\end{figure}
Detectron2 affiche aussi une loss total, nous n'avons pas réussis à determiner la manière dont elle est calculée, mais elle reste un bon indicateur de la performance du model et de l'over/under fitting.
\begin{figure}[h!]
    \centering
