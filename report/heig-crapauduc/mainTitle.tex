...
\textsc{\Large Gestion et valorisation de projet de Machine Learning}\\[0.5cm] % Major heading such as course name
...
\emph{Authors:}\\
\textsc{Schaller} Joris\\ % Your name
\textsc{D'Ancona} Olivier\\ % Your name
\textsc{Logan}  Victoria\\ % Your name
\textsc{Akoumba} Erica Ludivine\\ % Your name
\textsc{Wichoud} Nicolas\\ % Your name
